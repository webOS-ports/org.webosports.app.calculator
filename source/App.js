		...
		{name: "tabletop", kind: "Control", fit: true, classes:"tabeltop", components: [
			...
			{name: "bezel", kind: "FittableRows", classes: "bezel",	components:[
				...
				{kind: "FittableRows", fit: true,
					defaultKind: enyo.kind({kind: "FittableColumns", style: "height: 15.5%; margin: 0.5%;",
						defaultKind: enyo.kind({kind: "onyx.Button", classes: "onyx-toolbar", style: "width: 24%; margin: 0.5%; border-radius: 8px; font-size: 24pt; font-weight: bold;", ontap: "keyTapped"})
					}),
					components:[
						{components:[
